type BulletSection = {
  ...
  const cookiesSections: CookiesSection[] = [
    {
      title: "What Are Cookies",
      content: [
        {
          paragraph:
            "Cookies are small files stored on a user's device, containing information about their preferences and activities on the platform.",
        },
      ],
    },
    {
      ...
      content: [
        {
          ...
          bullets: [
            "Temporary and deleted when the user closes their browser.",
          ],
        },
        {
          subtitle: "Persistent Cookies",
          bullets: [
            "Remain on the user's device for a specified period.",
          ],
        },
        {
          subtitle: "Analytical Cookies",
          bullets: [
            "Used for tracking and analyzing user behavior.",
          ],
        },
      ],
    },
      ...
      content: [
        {
          bullets: [
            ...
            "Disabling cookies may affect the functionality of certain features on Tobams Group Academy.",
          ],
        } as BulletSection,
      ],
    },
    {
      ...
      content: [
        {
          paragraph:
            "Tobams Group Academy may update the cookie policy to reflect changes in technology or legal requirements.",
        },
      ],
    },
    {
  ...
  export default function CookiesContentSection() {
    return (
      <>
        {/* Main Terms Content */}
