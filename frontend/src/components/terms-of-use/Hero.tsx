  ...
  return (
    <section className="relative w-full md:h-[414px] py-[42px] flex items-center justify-center text-center text-white overflow-hidden bg-[#101321]">
      ...
      <div className="relative z-10 max-w-4xl px-6">
        ...
        By accessing or using the Tobams Group Academy, you agree to comply with and be bound by these Terms of Use. If you do not agree with any part of these terms, you may not access the Platform.
        </p>
